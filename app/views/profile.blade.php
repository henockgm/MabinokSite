        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <form class="upload-profile-image-form" enctype="multipart/form-data" action="{{ URL::route('update-avatar') }}" method="POST">
                    ...
                    <a class="image-upload-info" href="#" data-toggle="tooltip" data-placement="right" title="upload square type image for best view. eg. 500X500px or 700X700px with max size = 2M"> <span class="glyphicon glyphicon-info-sign"></span></a>
