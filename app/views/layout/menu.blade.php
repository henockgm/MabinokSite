      ...
      <div class="collapse navbar-collapse" id="myNavbar">          
        ...
        <ul class="nav navbar-nav navbar-right navbar-top">
          @if(Auth::check())
            ...
            <li class="main-nav"> <a href="#" class="nav-item"> {{ Auth::user()->username }}</a> </li>
            <li class="dropdown main-nav">
              <a class="dropdown-toggle nav-item" data-toggle="dropdown" href="#">  <span class="glyphicon glyphicon-cog"></span> Setting <span class="caret"></span> </a>
              <ul class="dropdown-menu" role="menu">
                <li> <a href="{{ URL::route('show-user-profile') }}"> Profile </a> </li>  
                <li> <a href="#"> Change your details </a> </li>          
