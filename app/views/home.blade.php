...
<div class="container home-container alt1">
	...
	<div class="create-post-btn" > <a href="{{ URL::route('create-blog-post') }}" class="btn btn-orange-white btn btn-xl"><span class="glyphicon glyphicon-pencil"></span> Create a Post</a> </div>
